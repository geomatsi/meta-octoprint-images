...
do_install_append() {
	...
	install -m 0644 ${S}/contrib/pull-resolv-conf/client.up ${D}${sysconfdir}/openvpn/resolv/
	install -m 0644 ${S}/contrib/pull-resolv-conf/client.down ${D}${sysconfdir}/openvpn/resolv/
